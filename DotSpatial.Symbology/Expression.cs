...
namespace DotSpatial.Symbology
{
    public class Expression
    {
        ...
        public string CalculateRowValue(DotSpatial.Data.IDataRow row, int FID)  // CGX AERO GLZ
        {
            if (IsEmpty()) return "";
            _errorMessage = "";
        ...
        public bool IsValidOperation(ref string retVal, DotSpatial.Data.IDataRow row = null) // CGX AERO GLZ
        {
        ...
        public bool UpdateFields(Data.IDataColumnCollection columns) // CGX AERO GLZ
        {
            ClearFields();
        ...
        private string ReplaceFieldsOnly(DotSpatial.Data.IDataRow row, int FID) // CGX AERO GLZ
        {
