...
namespace DotSpatial.Projections.Tests.Projected.NationalGrids
{
    ...
    public class Canada
    {
        ...
        public void NationalGridsCanadaProjectedTests(ProjectionInfoDesc pInfo)
        {
        ...
        {
            return ProjectionInfoDesc.GetForCoordinateSystemCategory(KnownCoordinateSystems.Projected.NationalGrids.Canada);
        }
