...
namespace DotSpatial.Projections.Tests.Projected.NationalGrids
{
    ...
    /// </summary>
    [TestFixture]
    public class MalaysiaSingapore
        {
        [Test]
        ...
        {
            return ProjectionInfoDesc.GetForCoordinateSystemCategory(KnownCoordinateSystems.Projected.NationalGrids.MalaysiaSingapore);
        }
    }
}