...
{
    /// <summary>
    /// This class contains all the tests for the StatePlane.Nad1983Meters category of Projected coordinate systems.
    /// </summary>
    [TestFixture]
    public class Nad1983Meters
    {
        [Test]
        ...
        {
            return ProjectionInfoDesc.GetForCoordinateSystemCategory(KnownCoordinateSystems.Projected.StatePlane.Nad1983Meters);
        }
