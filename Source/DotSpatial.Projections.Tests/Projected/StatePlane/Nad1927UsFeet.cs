...
{
    /// <summary>
    /// This class contains all the tests for the StatePlane.Nad1927UsFeet category of Projected coordinate systems.
    /// </summary>
    [TestFixture]
    [Ignore("Tests fails only on x64. It seems proj.dll issue.")]
    public class Nad1927UsFeet
    {
        [Test]
        ...
        {
            return ProjectionInfoDesc.GetForCoordinateSystemCategory(KnownCoordinateSystems.Projected.StatePlane.Nad1927UsFeet);
        }
