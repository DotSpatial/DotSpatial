...
namespace DotSpatial.Projections.Tests
{
    ...
    public class KrovakTest
    {
        ...
        [TestMethod]
        public void Wgs84ToKrovakKnownCoordSys()
        {
            double[] myOut = new double[2];
            myOut[0] = 12.8069888666667;
            myOut[1] = 49.4522626972222;
            ...
            ProjectionInfo source = KnownCoordinateSystems.Geographic.World.WGS1984;
            ProjectionInfo myJtskpi = KnownCoordinateSystems.Projected.NationalGrids.Europe.SJTSKKrovakEastNorth;
        ...
        [TestMethod]
        public void KrovakToWgs84KnownCoordSys()
        {
            double[] myOut = new double[2];
            myOut[0] = -868208.52;
            myOut[1] = -1095793.96;      
        ...
        [TestMethod]
        public void KrovakToWgs84EsriString()
        {
            double[] myOut = new double[2];
            myOut[0] = -868208.52;
            myOut[1] = -1095793.96;        
        ...
        [TestMethod]
        public void KrovakToWgs84EsriString2()
        {
            double[] myOut = new double[2];
            myOut[0] = -651782.34;
            myOut[1] = -978039.99;
