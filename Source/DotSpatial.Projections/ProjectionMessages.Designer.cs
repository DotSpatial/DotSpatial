...
namespace DotSpatial.Projections {
    ...
    internal class ProjectionMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The projection with the authority code {0} was already added..
        /// </summary>
        internal static string ProjectionWithAuthorityCode0WasAlreadyAdded {
            get {
                return ResourceManager.GetString("ProjectionWithAuthorityCode0WasAlreadyAdded", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to The projection with the name {0} was already added..
        /// </summary>
        internal static string ProjectionWithName0WasAlreadyAdded {
            get {
                return ResourceManager.GetString("ProjectionWithName0WasAlreadyAdded", resourceCulture);
            }
        }
    }
}
