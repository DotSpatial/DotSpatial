...
{
    /// <summary>
    /// This MapPointLayer is able to load itself on deserialization even if the contained DataSet doesn't know how to load the file.
    /// </summary>
    public class MapSelfLoadPointLayer : MapPointLayer, IMapSelfLoadLayer
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MapSelfLoadPointLayer"/> class.
        /// </summary>
        /// <param name="featureSet">The FeatureSet that contains the layers data.</param>
        public MapSelfLoadPointLayer(IFeatureSet featureSet)
            : base(featureSet)
        {
