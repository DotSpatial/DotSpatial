...
nuget pack ..\DotSpatial.Python\DotSpatial.Python.csproj -version "%NugetVersion%" -Properties "PackageVersion=%PackageVersion%";"Configuration=Release"
nuget pack ..\DotSpatial.Data.Rasters.GdalExtension\DotSpatial.Data.Rasters.GdalExtension.csproj -version "%NugetVersion%" -Properties "PackageVersion=%PackageVersion%";"Configuration=Release"
nuget pack ..\DotSpatial.Plugins.Measure\DotSpatial.Plugins.Measure.csproj -version "%NugetVersion%" -Properties "PackageVersion=%PackageVersion%";"Configuration=Release"