...
namespace DotSpatial.Positioning.Tests
{
    ...
    internal class NmeaTests
    {
        ...
        public void GprmcSentenceFromObjects()
        {
            ...
            Assert.AreEqual("$GPRMC,220516.000,A,5133.8200,N,00042.2400,W,173.8,231.8,130604,4.2,W*67",
                sentence.Sentence);
        ...
        {
            GprmcSentence sentence =
                new GprmcSentence("$GPRMC,194530.000,A,3051.8007,N,10035.9989,W,1.49,111.67,310714,,,A*74");
        ...
        public void GpgsvSentenceFromString()
        {
            ...
            GpgsvSentence sentence =
                new GpgsvSentence("$GPGSV,2,1,08,02,59,282,00,03,42,287,00,06,16,094,00,15,80,090,48*79");
