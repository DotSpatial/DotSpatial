...
namespace DotSpatial.Controls
{
    ...
    public partial class LayoutControl : UserControl
    {
        ...
        /// </summary>
        //CGX internal -> public
        public List<LayoutElement> SelectedLayoutElements
        {
        ...
        public void AddToLayout(LayoutElement le)
        {
            ...
            // CGX
            le.Unit = LayoutElement.eSizeUnit.Millimeters;
            //Fin CGX
            Invalidate(new Region(PaperToScreen(le.Rectangle)));
        }
        ...
        public void MoveSelectionUp()
        {
            ...
            if (_selectedLayoutElements.Count > 0)
            {
                ...
                List<LayoutElement> leSelected = _selectedLayoutElements.OrderBy(o => _layoutElements.IndexOf(o)).ToList();
                int index = _layoutElements.IndexOf(leSelected[0]);
                if (index == 0) return;
        ...
        public void UpdateLayoutElements()
        {
            if (DicoUndoRedoElements.ContainsKey(iCurrentStep))
            {
                ...
                if (List != null)
                {
                    ...
                    {
                        LayoutElement le = _layoutElements[i];
                    ...
                    {
                        LayoutElement le = GetElement(_layoutElements, List[i].element);

                        if (le == null)
                        {
                            _layoutElements.Insert(0, List[i].element);
