...
namespace DotSpatial.Data
{
    ...
    public interface IAttributeSource
    {
        ...
        IDataTable GetAttributes(int startIndex, int numRows); // CGX AERO GLZ
        ...
        IDataTable GetAttributes(int startIndex, int numRows, IEnumerable<string> fieldNames); // CGX AERO GLZ
        ...
        void SetAttributes(int startIndex, IDataTable pageValues); // CGX AERO GLZ
        ...
        /// </summary>
        /// <param name="values">The values organized against the dictionary of field names.</param>
        void AddRow(IDataRow values); // CGX AERO GLZ
        ...
        /// <param name="index">the integer row (or FID) index</param>
        /// <param name="values">The dictionary of object values by string field name holding the new values to store.</param>
        void Edit(int index, IDataRow values); // CGX AERO GLZ
