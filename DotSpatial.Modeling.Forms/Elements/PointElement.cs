// ********************************************************************************************************
// Product Name: DotSpatial.Tools.PointElement
...
namespace DotSpatial.Modeling.Forms
{
    internal class PointElement : DialogElement
    {
            ...
            if (_dataSets != null)
            {
                foreach (DataSetArray dsa in _dataSets)
                {
                    ...
                    if (aFeatureSet != null)
                    {
                        ...
                        if (aFeatureSet.FeatureType == FeatureType.Point && comboFeatures.Items.Contains(dsa) == false)
                        {
        ...
        private void BtnAddDataClick(object sender, EventArgs e)
        {
            ...
            {
                _addedFeatureSet = new DataSetArray(Path.GetFileNameWithoutExtension(tempFeatureSet.Filename),
                                                    tempFeatureSet);
