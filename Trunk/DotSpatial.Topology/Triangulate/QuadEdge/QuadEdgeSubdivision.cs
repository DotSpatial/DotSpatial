...
#else
using ISet = Wintellect.PowerCollections.Set<DotSpatial.Topology.Triangulate.QuadEdge.QuadEdge>;
using HashSetQ = Wintellect.PowerCollections.Set<DotSpatial.Topology.Triangulate.QuadEdge.QuadEdge>;
using HashSetV = Wintellect.PowerCollections.Set<DotSpatial.Topology.Triangulate.QuadEdge.Vertex>;
#endif
