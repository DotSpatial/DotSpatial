...
namespace DotSpatial.Topology.Geometries
{
    ...
    public class OctagonalEnvelope
    {
        ...
        {
            ExpandToInclude(env.Minimum.X, env.Minimum.Y);
            ExpandToInclude(env.Minimum.X, env.Maximum.Y);
            ExpandToInclude(env.Maximum.X, env.Minimum.Y);
            ExpandToInclude(env.Maximum.X, env.Maximum.Y);
            return this;
        }
