...
namespace DotSpatial.Topology.Noding
{
    ...
    public class InteriorIntersectionFinder : ISegmentIntersector
    {
        ...
        {
            InteriorIntersectionFinder finder = new InteriorIntersectionFinder(li) { FindAllIntersections = true };
            return finder;
        }
        ...
        public void ProcessIntersections(ISegmentString e0, int segIndex0, ISegmentString e1, int segIndex1)
        {
            ...
            if (CheckEndSegmentsOnly && !(IsEndSegment(e0, segIndex0) || IsEndSegment(e1, segIndex1))) return;
            ...
            if (!_li.HasIntersection || !_li.IsInteriorIntersection()) return;
