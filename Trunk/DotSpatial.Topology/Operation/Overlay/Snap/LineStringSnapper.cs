...
namespace DotSpatial.Topology.Operation.Overlay.Snap
{
    /// <summary>
    ...
    public class LineStringSnapper
    {
        ...
        private readonly IList<Coordinate> _srcPts;
        ...
        public LineStringSnapper(IList<Coordinate> srcPts, double snapTolerance)
        {
            _srcPts = srcPts;
        ...
        private static bool IsClosed(IList<Coordinate> pts)
        {
            if (pts.Count <= 1) return false;
            return pts[0].Equals2D(pts[pts.Count - 1]);
        }
