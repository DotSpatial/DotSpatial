...
namespace DotSpatial.Controls
{
    ...
    /// </summary>
    public abstract partial class MapCore : IMap
    {
        #region Events
        ...
        protected IMapFrame _geoMapFrame;
        protected int _isBusyIndex;
        protected ILegend _legend;
        protected IProgressHandler _progressHandler;
        protected Size _oldSize;
        protected Dictionary<FunctionMode, IMapFunction> _functionLookup;
        protected FunctionMode _functionMode;
        ...
        void Configure()
        {
            ...
            FunctionLookup = new Dictionary<FunctionMode, IMapFunction>
                                  {
        ...
        internal void OnMouseMove(GeoMouseArgs args)
        {
            var h = GeoMouseMove;
        ...
        /// </summary>
        internal virtual void OnFunctionModeChanged(object sender, EventArgs e)
        {
            var h = FunctionModeChanged;
            if (h != null) h(this, e);
        }

        internal void OnSizeChanged(object sender, EventArgs eventArgs)
        {
            if (_geoMapFrame != null)
            {
                var diff = new Point { X = Width - _oldSize.Width, Y = Height - _oldSize.Height };
